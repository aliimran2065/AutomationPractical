...
public class blueBackgroundPage {
	...
	public void verifyButtonExists() {
		String buttonText = SKYBLUE_BACKGROUND_BUTTON.getText();
		if (buttonText.equalsIgnoreCase("Set SkyBlue Background")) {
	...
	// Clicks Sky blue background button
	public void clickSetBackgroundSkyBlueButton() {
	...
	public void validateBackgroundColorChangedToSkyBlue() {
		WebElement element = driver.findElement(By.cssSelector("body"));
		String actualBackgroundColor = element.getCssValue("background-color");
		String expectedBackgroundColor = rgbaValueOfSkyBlue;
